...
class FormularioEditGame extends Form {
    ...
    protected function generaCamposFormulario($datosIniciales) { // Devuelve el HTML necesario para presentar los campos del formulario.
        $game = Game::find($_GET['id']); // Busca el juego
        ...
        return '<div>
                    <div>
                        ...
                        <img class="cover-img" id="output" src="img/games/'.$game->company().'/'.$platform.'/'.$game->id().'.jpg" onerror="this.src=\'img/games/placeholder.png\'">
                    ...
                    <table>
                        ...
                        <tr>
                            <td>Release Year: </td>
                            <td>
                                <input class="form-control" id = "year" type="text" name="year" placeholder="DD-MM-YYYY" required>
                            </td>
                        </tr>
                        <tr>
                ...
                <div class="button-wrapper">
                   <button type="submit" class="button-create-game" id="game">Update</button>
                </div>';
    }
    ...
    protected function procesaFormulario($datos) { // Procesa los datos del formulario.
        ...
        if (empty($title) or empty($year) or empty($company))	{
            ...
            if ($insert) { // Hemos podido insertar el juego en la base de datos
                ...
                header('Location: addGame.php?error=duplicate');
                exit();
            }
        }
    }
